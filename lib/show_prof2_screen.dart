...
import 'see_reviews_screen2.dart';
class ShowProfile2 extends StatefulWidget {
  final Map<String, dynamic> user;

  const ShowProfile2({Key? key, required this.user}) : super(key: key);

  @override
  State<ShowProfile2> createState() => _ShowProfile2State();
}

class _ShowProfile2State extends State<ShowProfile2> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        GestureDetector(
                          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => SeeReview2(user:widget.user))),
