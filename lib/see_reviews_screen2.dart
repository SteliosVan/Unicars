...
class SeeReview2 extends StatefulWidget {
  final Map<String, dynamic> user;
  
  const SeeReview2({Key? key, required this.user}) : super(key: key);

  @override
  State<SeeReview2> createState() => _SeeReviewState2();
}

class _SeeReviewState2 extends State<SeeReview2> {
    ...
    return Stack(
      children: [
        Positioned(
          ...
          top: 24,
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ShowProfile2(user: user))),
            child: Container(
              width: 45,
              height: 45,
              decoration: const BoxDecoration(
