...
class SeeReview extends StatefulWidget {
  ...
  const SeeReview({Key? key, required this.user}) : super(key: key);
...
class DriverCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final rating = (userData['rating'] ?? 0).toInt();
    ...
    return Stack(
      children: [
        Positioned(
          ...
          top: 24,
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ShowProfile1(user: user))),
            child: Container(
              width: 45,
              height: 45,
              decoration: const BoxDecoration(
